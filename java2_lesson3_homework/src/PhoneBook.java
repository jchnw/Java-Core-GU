...
public class PhoneBook {
    ...
    public void get(String surname) {
        if (this.surname.contains(surname)){
            System.out.println("Номера, зарегестрированные под фамилией: " + this.surname.get(this.surname.indexOf(surname)) + ": " + this.number.get(this.surname.indexOf(surname)));
        }else {
            System.out.println ("Номеров, зарегистрированных под фамилией "+ surname + " не найдено.");
        }
    }
}
